package com.study.pageapp.activity;
...
import com.study.pageapp.fragment.BlueFragment;
import com.study.pageapp.fragment.RedFragment;
import com.study.pageapp.fragment.YellowFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void showPage(View view){
        ...
        switch (view.getId()){
            case R.id.red:index=0;break;
            case R.id.blue:index=1;break;
            case R.id.yellow:index=2;break;
        }
        showView(index);
    }
